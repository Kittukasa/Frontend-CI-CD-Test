...
import { Activity, BarChart, DollarSign, Download, Edit, Gift, Plus, Send, Settings, Star, Users, X } from 'lucide-react';
...
interface LoyaltyProps {
  ...
  onFormChange: <K extends keyof LoyaltyEditFormData>(field: K, value: LoyaltyEditFormData[K]) => void;
}
...
const Loyalty: React.FC<LoyaltyProps> = ({
  ...
  const activeProgramsCount = Object.values(loyaltyPrograms).filter(program => program.active).length;
  ...
  const editingProgramTitle = editingLoyalty ? loyaltyPrograms[editingLoyalty].title : 'Loyalty Program';
                  ...
                  <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-xl p-6 mb-6">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-green-400 text-sm font-medium">Active: {activeProgramsCount}</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="group relative">
                      <div 
                        className={`bg-gradient-to-br from-blue-600 to-purple-700 rounded-2xl shadow-2xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-3xl cursor-pointer border-2 ${
                          loyaltyPrograms.points.active ? 'border-blue-400 shadow-blue-500/25' : 'border-gray-600 opacity-75'
                        }`}
                      ...
                      >
                        ...
                        <div className="mb-6">
                          <p className="text-white/90 text-lg font-medium mb-2">{loyaltyPrograms.points.description}</p>
                          <div className="bg-white/10 rounded-lg p-3 space-y-2">
                            <div className="flex justify-between items-center text-white/80 text-sm">
                              <span>Conversion Rate:</span>
                              <span className="font-bold">₹1 = {pointsConversionRate} point{pointsConversionRate !== 1 ? 's' : ''}</span>
                            </div>
                            <div className="flex justify-between items-center text-white/80 text-sm">
                    ...
                    <div className="group relative">
                      <div 
                        className={`bg-gradient-to-br from-green-600 to-emerald-700 rounded-2xl shadow-2xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-3xl cursor-pointer border-2 ${
                          loyaltyPrograms.cashback.active ? 'border-green-400 shadow-green-500/25' : 'border-gray-600 opacity-75'
                        }`}
                      ...
                      >
                        ...
                        <div className="mb-6">
                          <p className="text-white/90 text-lg font-medium mb-2">{loyaltyPrograms.cashback.description}</p>
                    ...
                    <div className="group relative">
                      <div 
                        className={`bg-gradient-to-br from-orange-600 to-red-700 rounded-2xl shadow-2xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-3xl cursor-pointer border-2 ${
                          loyaltyPrograms.freeItem.active ? 'border-orange-400 shadow-orange-500/25' : 'border-gray-600 opacity-75'
                        }`}
                  ...
                  <div className="bg-gray-900 rounded-2xl shadow-xl p-6 border border-gray-700">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <p className="text-gray-400">Expand your loyalty ecosystem with additional program types</p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      >
                        ...
                        <div className="mt-3 flex items-center justify-between">
                          <div className={`text-xs font-medium ${loyaltyPrograms.appReferral.active ? 'text-green-400' : 'text-gray-500'}`}>
                      ...
                      >
                        ...
                        <div className="mt-3 flex items-center justify-between">
                          <div className={`text-xs font-medium ${loyaltyPrograms.influencerReferral.active ? 'text-green-400' : 'text-gray-500'}`}>
                ...
                <div className="space-y-4">
                          <div>
                            ...
                            <div className="relative">
                              <input
                                ...
                                onChange={(e) => onFormChange('conversionRate', parseFloat(e.target.value) || 1)}
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                              Customer earns {editFormData.conversionRate} point{editFormData.conversionRate !== 1 ? 's' : ''} for every ₹1 spent
                            </p>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <input
                                ...
                                onChange={(e) => onFormChange('redeemRate', parseFloat(e.target.value) || 0.10)}
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder="0.10"
                              />
                              <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                          ...
                          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <div className="text-sm text-blue-800 space-y-1">
                              <p>• Customer spends ₹100 → Earns {(editFormData.conversionRate * 100).toFixed(0)} points</p>
                              <p>• Customer redeems {Math.ceil(10 / editFormData.redeemRate)} points → Gets ₹{(Math.ceil(10 / editFormData.redeemRate) * editFormData.redeemRate).toFixed(2)}</p>
                            </div>
                          </div>
                        </div>
                      )}
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <input
                                ...
                                onChange={(e) => onFormChange('minPurchaseAmount', parseInt(e.target.value) || 1000)}
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                placeholder="1000"
                              />
                              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <input
                                ...
                                onChange={(e) => onFormChange('pointsPerReferral', parseInt(e.target.value) || 100)}
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <input
                                ...
                                onChange={(e) => onFormChange('referralBonus', parseInt(e.target.value) || 50)}
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                placeholder="50"
                              />
                              <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <input
                                ...
                                onChange={(e) => onFormChange('commissionRate', parseInt(e.target.value) || 15)}
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <input
                                ...
                                onChange={(e) => onFormChange('bonusAmount', parseInt(e.target.value) || 1000)}
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                                placeholder="1000"
                              />
                              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
