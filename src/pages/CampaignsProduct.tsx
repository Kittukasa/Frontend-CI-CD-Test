  ...
  const channels = [
    {
      ...
      description: 'Send rich media messages with images, offers, and links directly.',
    ...
    },
    {
      ...
      description: 'Create beautiful email campaigns with templates and tracking.',
  ...
  const features = [
    {
      ...
      description: 'Target customers by behavior, location, spend, and visit frequency.',
      gradient: 'from-pink-500 to-rose-600',
    },
    {
      icon: Calendar,
      title: 'Schedule Campaigns',
      description: 'Set up campaigns in advance and let them run automatically.',
      gradient: 'from-orange-500 to-red-600',
    },
    {
      icon: BarChart3,
      title: 'Real-Time Analytics',
      description: 'Track opens, clicks, and conversions for every campaign.',
      gradient: 'from-cyan-500 to-blue-600',
    },
    {
      icon: Zap,
      title: 'Automation Rules',
      description: 'Trigger campaigns based on customer actions and milestones.',
      gradient: 'from-indigo-500 to-purple-600',
    },
    {
      icon: Users,
      title: 'Audience Builder',
      description: 'Create custom audiences with advanced filters and conditions.',
      gradient: 'from-green-500 to-teal-600',
    },
    {
      icon: Send,
      title: 'One-Click Send',
      description: 'Launch campaigns to hundreds of customers with a single click.',
  ...
  const useCases = [
    {
      ...
      description: 'Launch Diwali, New Year, or seasonal promotions across all channels.',
    },
    {
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 py-32">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-10 leading-relaxed max-w-3xl mx-auto">
              ...
              Reach hundreds of customers in minutes with personalized campaigns that convert.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 text-white px-8 py-6 text-lg font-semibold rounded-xl transition-all duration-300 hover:scale-105 shadow-2xl"
              >
                Start Free Trial
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Billbox Campaigns lets you create and launch promotions across WhatsApp, SMS, and
                Email from one unified platform. No technical skills required — just select your
                audience, craft your message, and send.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Whether you're running a flash sale, announcing a new product, or re-engaging
                dormant customers, Billbox makes it effortless to reach your audience at scale.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {channels.map((ch, i) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${ch.gradient} rounded-xl flex items-center justify-center mb-6 shadow-lg`}
                  >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
              Start engaging customers with powerful, targeted campaigns that drive sales.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 text-white px-10 py-7 text-lg font-semibold rounded-xl shadow-2xl hover:scale-105 transition-all"
              >
                Start Free Trial
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
