...
export function ComparisonDemo() {
    ...
    const { data: newWayData, isLoading: newWayLoading, error: newWayError } = useDashboardData(
        { storeId },
        { enabled: !!storeId }
    );
                    ...
                    <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
                        ...
                        <div className="space-y-3 font-mono text-sm">
                            <div className="bg-white p-3 rounded border border-red-200">
                                ...
                                <p className="text-gray-800">const storeId = localStorage.getItem('bb_store_id');</p>
                            ...
                            <div className="bg-gray-100 p-3 rounded">
                                ...
                                <p className="text-gray-800">Token: {localStorage.getItem('bb_token')?.slice(0, 20)}...</p>
                                <p className="text-gray-800">Store ID: {localStorage.getItem('bb_store_id') || 'Not found'}</p>
                            ...
                            <div className="bg-gray-100 p-3 rounded">
                                ...
                                {isAuthenticated ? (
                                    <>
                                        ...
                                        <p className="text-blue-600">⏱️ Expires in: {formatTimeRemaining(timeUntilExpiry)}</p>
                                        <button
                        ...
                        <div className="space-y-3">
                            ...
                            {oldWayData && (
                                <div className="bg-white p-4 rounded border border-gray-300">
                                    ...
                                    <p className="text-xs text-gray-600">Time taken: <strong className="text-red-600">{oldWayTime}ms</strong></p>
                                    <p className="text-xs text-gray-600 mt-2">Data keys: {Object.keys(oldWayData).join(', ')}</p>
                        ...
                        <div className="space-y-3">
                            ...
                            {newWayData && (
                                <div className="bg-white p-4 rounded border border-green-300">
                                    ...
                                    <p className="text-xs text-gray-600">Time taken: <strong className="text-green-600">{newWayTime}ms</strong></p>
                                    <p className="text-xs text-gray-600 mt-2">Data available: Revenue, Invoices, Campaigns</p>
                                    <p className="text-xs text-green-600 mt-2">✅ Cached for 5 minutes - instant on revisit!</p>
                                    <p className="text-xs text-blue-600 mt-1">🔄 Refresh this page - data loads instantly from cache</p>
                                </div>
                            )}
