...
const EBillProduct = () => {
  const advantages = [
    {
      ...
      description: 'Send receipts directly to WhatsApp or SMS within seconds.',
      gradient: 'from-cyan-500 to-blue-600',
    },
    {
      icon: Sparkles,
      title: 'Smart Branding',
      description: 'Add your logo, website, offers, and promo banners on Smart E-Bills.',
      gradient: 'from-violet-500 to-purple-600',
    },
    {
      icon: BarChart3,
      title: 'Data-Driven',
      description: 'Capture customer name, phone, spend, and engagement automatically.',
      gradient: 'from-blue-500 to-cyan-500',
    },
    {
      icon: Leaf,
      title: 'Eco-Friendly',
      description: 'Reduce waste and go paperless effortlessly.',
      gradient: 'from-green-500 to-emerald-600',
    },
    {
      icon: FileText,
      title: 'Easy Setup',
      description: 'No integration or tech team required - works instantly.',
      gradient: 'from-orange-500 to-red-600',
    },
    {
      icon: Shield,
      title: 'Secure & Compliant',
      description: 'AES-encrypted storage and verified sender IDs.',
      gradient: 'from-purple-500 to-pink-600',
    },
  ];

  const paperProblems = [
    'Wastes paper and printing cost',
    'Fades over time and hard to track',
    'No customer insights or data collected',
    'No way to follow up or re-engage customers',
    'Manual storage and compliance hassle',
  ];
  const ebillBenefits = [
  ...
  const steps = [
    {
      number: '01',
      title: 'Print or Generate',
      description: 'Continue billing as usual - no changes to your workflow.',
    },
    {
      number: '02',
      title: 'Auto-Convert & Brand',
      description:
        'Billbox instantly digitizes the receipt; Smart E-Bills add banners, branding, and CTAs automatically.',
    },
    {
      number: '03',
      title: 'Instant Delivery',
      description:
        'Customer receives E-Bills or Smart E-Bills on WhatsApp, SMS, or Email immediately.',
    },
  ];
  ...
  const billOptions = [
    {
      ...
      tag: 'Standard',
      description:
        'Fast, paperless receipts sent to WhatsApp, SMS, or Email with all transaction details captured.',
      features: [
        'Instant digital delivery',
        'Secure, compliant storage',
        'Customer name and contact captured',
      ],
      accent: 'violet',
    },
    {
      ...
      tag: 'Enhanced',
      description:
        'Everything in E-Bills plus rich branding: promotional banners, store logo, dynamic content, and CTAs.',
      features: [
        'Promotional banners and offers',
        'Store branding + logo on every bill',
        'Dynamic content blocks and CTAs',
        'Engagement tracking and re-marketing',
      ],
      accent: 'cyan',
      highlight: true,
    },
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="block bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">
                Hello E-Bills & Smart E-Bills.
              </span>
            </h1>
            <p className="text-xl lg:text-2xl text-gray-300 mb-10 leading-relaxed max-w-3xl mx-auto">
              Choose fast digital E-Bills or upgrade to Smart E-Bills with promotional banners,
              store branding, your logo, and dynamic content that turn every receipt into a
              mini-campaign.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-8 py-6 text-lg font-semibold rounded-xl transition-all duration-300 hover:scale-105 shadow-2xl"
              >
                Start Free Trial
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Billbox replaces traditional printed receipts with secure digital copies delivered
                instantly to your customer's WhatsApp, SMS, or Email. Choose standard E-Bills for
                fast, paperless delivery, or Smart E-Bills for richer engagement.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Smart E-Bills layer promotional banners, store branding, your logo, and dynamic
                content/CTAs on top of every receipt — so you engage customers while you bill.
              </p>
                ...
                {billOptions.map(option => (
                  <div
                    ...
                    className={`relative p-6 rounded-2xl border-2 ${
                      option.highlight
                        ? 'border-cyan-200 bg-gradient-to-br from-cyan-50 to-white shadow-xl'
                  ...
                  >
                        ...
                        <div key={i} className="flex items-start gap-3">
                          <CheckCircle2
                            className={`w-5 h-5 mt-0.5 flex-shrink-0 ${
                              option.highlight ? 'text-cyan-600' : 'text-violet-600'
                            }`}
                          />
                    ...
                    {option.highlight && (
                      <span className="absolute top-4 right-4 text-xs font-semibold text-cyan-700 bg-cyan-100 px-3 py-1 rounded-full">
                        Enhanced
                      </span>
                    )}
                  </div>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Paper billing is slow, costly, and invisible after checkout. E-Bills modernize
              delivery, while Smart E-Bills add branding and offers on every receipt.
            </p>
          </motion.div>
          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border-2 border-green-300 shadow-lg"
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">
                  Smart E-Bill Advantages (Enhanced)
                </h3>
              </div>
              <ul className="space-y-4">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-extrabold text-gray-900 mb-4">
              ...
              <span className="block bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">
                Billbox E-Bills & Smart E-Bills
              </span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Everything you need to keep billing digital, branded, and revenue-ready with Smart
              E-Bills.
            </p>
          </motion.div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {advantages.map((adv, i) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${adv.gradient} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                  >
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-violet-50 via-purple-50 to-pink-50">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Seamlessly integrates into your existing workflow without technical hassle.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Join hundreds of businesses already transforming with Billbox E-Bills and Smart
              E-Bills.
            </p>
          </motion.div>
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              { stat: '8K+', label: 'Digital Bills Sent', icon: FileText },
              { stat: '50%', label: 'Cost Savings', icon: TrendingUp },
              { stat: '45%', label: 'Returning Customers', icon: Users },
            ].map((item, i) => {
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              {
                quote:
                  'Billbox helped us go fully digital within a week — customers love getting bills on WhatsApp!',
                author: 'Sakesh Kumar',
                role: 'Owner,  Retail',
              },
              {
                quote:
                  'Switching to Smart E-Bills lets us run offers and branding on every receipt while saving cost.',
                author: 'Priya Sharma',
            ...
            >
              ...
              <h2 className="text-4xl lg:text-5xl font-extrabold text-gray-900 mb-6">
                ...
                <span className="block bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
                  Save Trees. Build Trust.
                </span>
              </h2>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Every digital receipt reduces paper waste and your carbon footprint. Billbox helps
                your business go green without sacrificing convenience.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Show customers you care about the environment while building a modern, sustainable
                business that stands out from competitors.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl lg:text-6xl font-extrabold mb-6">
              Start Sending
              <span className="block bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                E-Bills & Smart E-Bills Today.
              </span>
            </h2>
            <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
              Choose simple E-Bills or Smart E-Bills with branding and offers — and turn every
              receipt into growth.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
