...
import { Menu, X, ChevronDown, Gift, Building2, Database, BrainCircuit, Zap, MessageSquare, Megaphone, Star, ShoppingCart, Pill, Coffee, Shirt, Monitor, Scissors, Network, FileText, BarChart3, Bot, Rocket } from 'lucide-react';
...
export function GlobalNavbar({ className }: GlobalNavbarProps) {
  ...
  const products = [
    ...
    },
    {
      ...
      description: 'Track customer behavior, spending patterns, and new vs. returning visits — all in one dashboard.',
    ...
    },
    {
      icon: Megaphone,
      name: 'Campaigns',
      description: 'Create and send targeted promotions across WhatsApp, SMS, and Email effortlessly.',
      href: '/products/campaigns'
    },
    {
      icon: MessageSquare,
      name: 'Pre-Defined Templates',
      description: 'Access 1000+ pre-approved message templates for offers, promotions, and reminders.',
      href: '/products/templates'
    },
    {
      icon: Star,
      name: 'Feedbacks',
      description: 'Collect real-time customer reviews and insights directly through e-bills or WhatsApp links.',
  ...
  const comingSoonProducts = [
    {
      ...
      description: 'A unified platform to consolidate, segment, and activate customer data in real time.',
      href: '/#products/cdp'
    },
    {
      icon: Gift,
      name: 'Rewards & Coupons',
      description: 'Reward returning customers with cashback, points, and exclusive perks — automatically.',
  ...
  const solutions = [
    {
      ...
      description: 'Automate e-bills, rewards & coupons, and customer insights for chain stores and franchises.',
      href: '/#solutions/retail'
    },
    {
      icon: Pill,
      name: 'Pharmacies & Healthcare',
      description: 'Send digital bills, refill reminders, and health campaign updates via WhatsApp.',
      href: '/#solutions/pharmacy'
    },
    {
      icon: Coffee,
      name: 'Restaurants & Cafes',
      description: 'Replace printed bills with WhatsApp receipts, run table-specific offers, and gather reviews.',
      href: '/#solutions/restaurants'
    },
    {
      icon: Shirt,
      name: 'Fashion & Lifestyle Stores',
      description: 'Track premium customers, launch festive sales, and reward repeat visits with rewards & coupons.',
    ...
    },
    {
      ...
      description: 'Automate appointment reminders, rewards & coupons cashback, and feedback collection.',
      href: '/#solutions/salons'
    },
    {
      icon: Network,
      name: 'Franchise Chains & Multi-Store Brands',
      description: 'Get unified analytics, chain-wide campaign tools, and region-level growth tracking.',
            ...
            <div className="flex items-center gap-6 lg:gap-10">
              ...
              {navLinks.map((link) => (
                ...
                >
                  {link.hasDropdown ? (
                    <button
                      className="relative px-4 py-2 text-sm lg:text-base font-medium text-white/70 hover:text-white transition-colors group flex items-center gap-1"
                    >
                      {link.label}
                      <ChevronDown className={cn(
                        "w-4 h-4 transition-transform duration-200",
                        (link.dropdownType === 'products' && productsDropdownOpen) && "rotate-180",
                        (link.dropdownType === 'solutions' && solutionsDropdownOpen) && "rotate-180"
                      )} />
                                        ...
                                        >
                                          <div className="flex flex-col gap-2">
                                            <div className="flex items-center gap-2">
                                              <div className={`flex-shrink-0 w-8 h-8 bg-gradient-to-br ${gradients[index]} rounded-lg flex items-center justify-center shadow-md`}>
                    ...
                    <AnimatePresence>
                      {solutionsDropdownOpen && (
                        ...
                        >
                          ...
                          <div className="p-6">
                            <div className="mb-4">
                              <h3 className="text-sm font-semibold text-violet-600 uppercase tracking-wide">Industry Solutions</h3>
                            </div>
                            <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      {link.hasDropdown ? (
                        <div className="space-y-2">
                          ...
                          <button
                            onClick={() => {
                              if (link.dropdownType === 'products') setMobileProductsOpen(!mobileProductsOpen);
                              if (link.dropdownType === 'solutions') setMobileSolutionsOpen(!mobileSolutionsOpen);
                            }}
                          ...
                          >
                            ...
                            <ChevronDown className={cn(
                              ...
                              (link.dropdownType === 'products' && mobileProductsOpen) && "rotate-180",
                              (link.dropdownType === 'solutions' && mobileSolutionsOpen) && "rotate-180"
                            )} />
                          </button>
                                ...
                                <div className="pl-4 space-y-1 pt-2">
                                  ...
                                  <div className="pt-3 mt-3 border-t border-white/10">
                                    <div className="flex items-center gap-2 px-3 mb-2">
                                      <span className="text-xs font-semibold text-white/40 uppercase tracking-wide">Coming Soon</span>
