...
const HowItWorksSteps = () => {
  ...
  const steps = [
    {
      ...
      details: "Customers receive professional digital bills with your branding, payment links, and store information",
    ...
    },
    {
      ...
      description: "Launch targeted WhatsApp campaigns to drive repeat purchases with rewards & coupons",
  ...
  return (
    <section id="how-it-works" className="py-20 bg-gradient-to-b from-slate-900 to-black relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6">
            How Billbox
            <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"> Works</span>
          </h2>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative mb-8">
                        <div className={`w-24 h-24 mx-auto rounded-full bg-gradient-to-r ${step.bgColor} border-2 ${step.borderColor} flex items-center justify-center transition-all duration-500 ${
                        ...
                        {/* Step Number */}
                        <div className={`absolute -top-2 -right-2 w-8 h-8 rounded-full bg-gradient-to-r ${step.color} flex items-center justify-center text-white font-bold text-sm`}>
                          {index + 1}
                        </div>
                      </div>

                      {/* Content */}
                      <div className={`bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-8 border border-white/10 transition-all duration-500 ${
                ...
                >
                  <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                    ...
                    <div className="flex items-center mb-6">
                      <div className={`w-16 h-16 rounded-full bg-gradient-to-r ${step.bgColor} border-2 ${step.borderColor} flex items-center justify-center mr-4`}>
                        <Icon className="w-8 h-8 text-white/90 drop-shadow" />
                      </div>
                      <div>
                        <div className={`w-8 h-8 rounded-full bg-gradient-to-r ${step.color} flex items-center justify-center text-white font-bold text-sm mb-2`}>
                          {index + 1}
                        </div>
